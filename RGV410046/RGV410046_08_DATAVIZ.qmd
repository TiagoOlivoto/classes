...
leaflet() %>%
  ...
  addMarkers(lng= -48.54,
             lat= -27.69,
             popup="The birthplace of R")

```

Os dados são em escala horária, do dia 01/01/2022 a 28/11/2022, totalizando 7957 observações. Estes dados serão utilizados ainda neste material, na sessão @sec-dados-da-estação.

```{r}
df_estacao <-  
  import("estacao_fazenda.csv", setclass = "tbl") |>
  mutate(dia = dmy(dia),
         m = fct_relevel(factor(m), paste0(1:11))) # reordena os meses
df_estacao
```
