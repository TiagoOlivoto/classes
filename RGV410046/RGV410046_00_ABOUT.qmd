...
events[27] <- "Entrega do desafio (sem atividade presencial)"
...
calendR(year = 2022,
        ...
        # bg.img = img,
        legend.pos = "bottom")
ggplot2::ggsave("cronograma2.jpg", width = 5.5, height = 5.5)
```

# Salas
* 106 - PGA: 14, 21, e 28/09 (quintas-feiras)
* 107 - PGA: 11, 15, 18, 22 e 25/09
...
# Forma de avaliação
A avaliação consistirá em uma metodologia baseado em problema, onde o aluno precisará apresentar uma solução para resolução de um desafio envolvendo o conteúdo visto na disciplina. O desafio será apresentado no ínicio da disciplina e o aluno deverá entrega-lo até o dia 27/09/2023.
