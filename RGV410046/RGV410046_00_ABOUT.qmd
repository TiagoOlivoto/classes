...
events <- rep(NA, 30)
events[c(14, 21, 28)] <- "Sala 106 - PGA"
events[c(11, 15, 18, 22, 25)] <- "Sala 107 - PGA"
events[27] <- "Entrega do desafio \nSem atividade presencial"

# img <- "figs/calendr.png"

# Creating the calendar
calendR(start_date ="2023-09-01",
        end_date = "2023-09-30",
        special.days = events,
        special.col =  c("lightgreen", "lightblue", "salmon"),
        title = "RGV410046\nIntrodução à linguagem R de programação", 
        subtitle = "Cronograma de aulas - 08:20 às 11:50",
        mbg.col = "forestgreen",            
        months.col = "white",
        # bg.img = img,
        legend.pos = "bottom")
