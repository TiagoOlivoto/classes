...
O conjunto de dados `dados_biost.xlsx` contém dados que podem ser utilizados para aplicação prática dos conteúdos trabalhados na disciplina. O arquivo contém as seguintes planilhas:
...
-   `FAT1_C2I`^[Olivoto, T., I.R. Carvalho, M. Nardino, M. Ferrari, A.J. de Pelegrin, et al. 2016. Sulfur and nitrogen effects on industrial quality and grain yield of wheat Efeitos. Rev. Ciências Agroveterinárias 15(1): 24--33. doi: 10.5965/223811711512016024.]: Fator 1 **Qualitativo** (enxofre), com dois níveis; Fator 2 **qualitativo** (parcelamento de N), com três níveis, **com interação significativa**.
...
<a href="http://bit.ly/df_biostat_exp" target="_blank" rel="noopener"> <button class="btn btn-success"><i class="fa fa-save"></i> Download dados_biost_exp.xlsx</button> </a>
