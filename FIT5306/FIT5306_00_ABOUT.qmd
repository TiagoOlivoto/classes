...
events <- rep(NA, 153)
segundas <- seq(11, 123, by = 7)
tercas <- seq(12, 124, by = 7)
events[segundas] <- "1: Aulas teóricas\nCCA/ZDR 201\nA/B/C: 13:30-16:00"
events[tercas] <- "2: Aulas práticas (campo)\nRessacada\nC: 10:10-11:50\nA: 13:30-15:10\nB: 15:20-17:00"

# Aulas práticas no CCA
events[c(33,  54,  61,  75, 82, 96, 110, 117, 124)] <- "3: Aulas práticas (análises)\nCCA\nC: 10:10-11:50\nA: 13:30-15:10\nB: 15:20-17:00"

# Provas
events[c(67, 130)] <- "3: Avaliações"

# Seminário
events[131] <- "4: Apresentação\ndo projeto"
