...
ggplot(dados, aes(value, fill = name)) +
  ...
  geom_vline(xintercept = mean(dados$value)) +
  scale_color_manual(values = metan::ggplot_color(4)) +
  scale_y_continuous(breaks = NULL, limits = (c(0.001, 1.5))) +
  theme_bw() +
  theme(panel.grid = element_blank())
```
...
```{=html}
<div align='center'><a href='https://www.free-website-hit-counter.com'><img src='https://www.free-website-hit-counter.com/c.php?d=9&id=138597&s=2' border='0' alt='Free Website Hit Counter'></a><br / ><small><a href='https://www.free-website-hit-counter.com' title="Free Website Hit Counter">Free website hit counter</a></small></div>
```
