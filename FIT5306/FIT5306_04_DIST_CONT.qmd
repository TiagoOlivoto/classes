...
O cálculo da integral da distribuição Normal pode ser aproximado pelo método geométrico por soma de retângulos (Ou [Soma de Riemann](https://pt.wikipedia.org/wiki/Soma_de_Riemann)). Este método possibilita calcular a integral definida em dois pontos (ex., $x_1$ e $x_2$), considerando uma variável com distribuição normal. Assim, a soma das áreas dos retângulos sob a curva da distribuição normal resultarão na probabilidade estatística de um valor estar no intervalo $x_1,x_2$.
...
[![](figs/normalp.png)](https://github.com/TiagoOlivoto/classes/blob/master/FIT5306/data/tabela_normal_padr%C3%A3o.pdf)
...
<iframe src="https://www.youtube.com/embed/ak3AgI_FPJw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
[![](figs/tabela_t.png)](https://github.com/TiagoOlivoto/classes/blob/master/FIT5306/data/tabela_t.pdf)
...
O pacote [ggstatplot](https://indrajeetpatil.github.io/ggstatsplot/index.html) pode ser utilizado para confecionar gráficos que incluem teste de hipóteses.
...
url <- "https://raw.githubusercontent.com/TiagoOlivoto/classes/refs/heads/master/FIT5306/data/pareado.csv"
paired <- rio::import(url)
paired
...
```{r}
url <- "https://raw.githubusercontent.com/TiagoOlivoto/classes/refs/heads/master/FIT5306/data/hibridos.csv"
df <- rio::import(url)
df
...
library(metan)
library(tidyverse)
url <- "https://raw.githubusercontent.com/TiagoOlivoto/classes/refs/heads/master/FIT5306/data/regua_foto.csv"
df <- rio::import(url)
df
```
...
t.test(comp_foto, comp_regua, paired = TRUE)
...
```{=html}
<div align='center'><a href='https://www.free-website-hit-counter.com'><img src='https://www.free-website-hit-counter.com/c.php?d=9&id=138594&s=2' border='0' alt='Free Website Hit Counter'></a><br / ><small><a href='https://www.free-website-hit-counter.com' title="Free Website Hit Counter">Free website hit counter</a></small></div>
```
